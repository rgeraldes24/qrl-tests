...
func (source contextSource) Genesis(context.Context) (beacon.Genesis, error) {
	return source.genesis, nil
}

func (source contextSource) Fork(context.Context) (beacon.Fork, error) {
...
func TestContextDomains(t *testing.T) {
	...
	source := contextSource{
		genesis: beacon.Genesis{ValidatorsRoot: "0x" + root, ForkVersion: "0x00000001"},
		fork: beacon.Fork{
