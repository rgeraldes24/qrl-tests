...
[`scenarios.yaml`](scenarios.yaml) is the machine-checked contract for every
source scenario. It records individual covered, missing, failing, and
unsupported behaviors and ties each implemented behavior to an executable
Ginkgo label.
