...
func committee(ctx context.Context, client consensusAPI, stateID string, data beacon.AttestationData) ([]uint64, error) {
	return client.Committee(ctx, stateID, data.Slot, data.CommitteeIndex)
}

func beaconBlockHeader(value beacon.BeaconBlockHeader) (consensuscrypto.BeaconBlockHeader, uint64, error) {
...
func attestationData(value beacon.AttestationData) (consensuscrypto.AttestationData, uint64, error) {
...
func depositData(value beacon.Deposit) (consensuscrypto.DepositData, error) {
